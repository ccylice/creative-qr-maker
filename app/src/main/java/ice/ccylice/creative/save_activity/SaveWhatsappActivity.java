...
public class SaveWhatsappActivity extends BaseActivity{
    ...
    public void onCopy() {
        super.onCopy();
        TextView textView = findViewById(R.id.result_whatsapp_input);
    ...
    protected int initLayout() {
        return R.layout.activity_result_whatsapp;
    }
    @Override
