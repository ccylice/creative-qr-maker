...
public class CreateViberActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_input = findViewById(R.id.Viber_input1);
        et_input = findViewById(R.id.Viber_input2);
        view_create = findViewById(R.id.viber_create);
...
//            Toast.makeText(this, "你没有输入二维码内容哟！", Toast.LENGTH_SHORT).show();
        ...
        Intent intent = new Intent(CreateViberActivity.this, QRcodeActivity.class);
        Bundle bundle = new Bundle();
        bundle.putInt("icon",R.drawable.viber);
        intent.putExtras(bundle);
        intent.putExtra("tv_title",content);
        intent.putExtra("tv_tit",str4);
        intent.putExtra("tv_name",getString(R.string.Viber));
        ...
        new Thread(){
            ...
            public void run() {
                super.run();
                Database database = Database.getInstance(CreateViberActivity.this);
                database.qRcodeDao().insertQrcode(new QRcode(content, BarcodeFormat.QR_CODE.ordinal(),2,str,"Viber"));
            }
        }.start();
...
//            }
    ...
    protected void setTitle() {
        super.setTitle();
        create_title.setText(getString(R.string.Viber));
    }
    @Override
